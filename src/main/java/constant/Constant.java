...
public class Constant {
    ...
    public static final String TEXT_BOX_PASSWORD = "Nhập mật khẩu của bạn";
    ...
    public static final String MESSAGE_UPDATE_SUCCESS_INFORM = "Lưu thành công";
    ...
    public static final String MESS_SIGN_UP_COMPARE_PASS = "Mật khẩu chưa trùng khớp";
    ...
    public static final String DE_ACTIVE_ACCOUNT_CONTENT = "1, Sau khi chọn vô hiệu hóa tài khoản, tài khoản sẽ được chuyển vào trạng thái lưu trữ trong 15 ngày.\n\n2, Trong 15 ngày tiếp theo từ ngày thực hiện thao tác, nếu tiếp tục đăng nhập vào ứng dụng thì thao tác vô hiệu hóa tài khoản sẽ bị hủy bỏ.\n\n3, Sau 15 ngày nếu không thực hiện thao tác đăng nhập vào ứng dụng, tài khoản của bạn sẽ bị vô hiệu hóa vĩnh viễn.\n\n4, Khi bạn vô hiệu hóa tài khoản, việc thanh toán các gói gia hạn vẫn sẽ được tiến hành Để tránh phát sinh chi phí gia hạn bạn cần quay lại gói cước để thực hiện hủy gia hạn";
}
